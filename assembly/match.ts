...
// import { AccountId, Match, MatchMode, MatchResult, MatchState, User, FEE_PERCENT, History } from "./model";
...
//     waitingMatch.set(matchId, new Match(matchId, bet, mode));
//     return matchId;
// }
...
//     }
//     userHistories.getSome(id).add(usrHistory);
//     return true;
// }
